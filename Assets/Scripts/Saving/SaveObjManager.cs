...
//		item.pos = newPos;
	...
	public static void MoveItem(GameObject gm,string newRoom, string newID,Direction newDir) {
		Instance.m_moveItem (gm, newRoom, newID, newDir);
	}

	void m_moveItem(GameObject go,string newRoom, string newID, Direction newDir) {
